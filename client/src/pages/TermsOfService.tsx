        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p>
              ...
              use of Smart Emailer Pro (the "Service"), an AI-powered email generation platform.
            </p>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              Smart Emailer Pro is an artificial intelligence-powered platform that generates professional, 
          ...
          <section>
            ...
            <p>
              ...
              intellectual property laws. Smart Emailer Pro is a registered trademark.
            </p>
          ...
          <section className="border-t pt-8 mt-8">
            <p className="text-sm text-muted-foreground">
              These Terms of Service are effective as of October 23, 2025. Smart Emailer Pro is a digital asset 
              owned and operated by Indus Bridge Ventures Inc. All rights reserved.
            </p>
            <p className="text-sm text-muted-foreground mt-4">
              By using Smart Emailer Pro, you acknowledge that you have read, understood, and agree to be bound 
