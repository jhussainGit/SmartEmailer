        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p>
              ...
              and protects your information when you use ProEmail AI (the "Service"), our AI-powered email 
          ...
          <section>
            ...
            <p>When you use ProEmail AI, we collect information you provide directly to us, including:</p>
          ...
          <section>
            ...
            <p>
              ProEmail AI uses OpenAI's GPT-5 model to generate email content. When you use our email generation feature:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-3">
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-muted rounded-lg">
              ...
              <p>Email: <a href="mailto:privacy@indusbridgeventures.com" className="text-primary hover:underline">
                privacy@indusbridgeventures.com
              </a></p>
          ...
          <section className="border-t pt-8 mt-8">
            <p className="text-sm text-muted-foreground">
              This Privacy Policy is effective as of October 23, 2025. ProEmail AI is a digital asset owned 
